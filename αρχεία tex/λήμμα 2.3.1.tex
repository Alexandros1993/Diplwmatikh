...
\begin{proof}
Θέτουμε $s(\alpha)=\sin(\pi\alpha)-2\alpha$. Τότε $s(0)=s(1/2)=0$. Αν $s(\alpha)=0$ για κάποιον $\alpha\in (0,1/2)$, τότε εφαρμόζοντας το θεώρημα του \tl{Rolle} για την παραγωγίσιμη συνάρτηση  $s$ στα $[0,\alpha]$ και 
